 ...
 * @author radityopw
 */
public class WeakEntityNode extends RectangularNode {
    public WeakEntityNode() {
    ...
    public void draw(Graphics2D g2) {
        ...
        Rectangle2D top = new Rectangle2D.Double(getBounds().getX(),
                ...
                getBounds().getHeight());
        Rectangle2D top2 = new Rectangle2D.Double(getBounds().getX()+2,
                getBounds().getY()+2, getBounds().getWidth()-4,
                getBounds().getHeight()-4);
        g2.draw(top);
        name.draw(g2, top);
        g2.draw(top2);
    ...
    public Object clone() {
        WeakEntityNode cloned = (WeakEntityNode) super.clone();
